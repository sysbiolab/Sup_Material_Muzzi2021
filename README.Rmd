...
author: "João C. D. Muzzi, Mauro A. A. Castro"
...
```{r boxplot-leukocyte-fraction-pan-cancer, fig.cap="Boxplot for Leukocyte Fraction pan-cancer comparison", fig.align="center", warning=F, fig.height=7}
...
```{r pan-cancer-immune-infiltrate, fig.cap="Boxplot for Immune Infiltrate Pan-Cancer comparison", fig.align="center", warning=F, fig.height=7}
...
```{r dds-volcano-plot, fig.cap="Volcano plot for Differential analysis results", fig.align="center", results=F, message=F, warning=F}
...
```{r tmod-analysis, fig.align="center", fig.cap="CERNO test for Enrichment analysis"}
...
```{r heatmap-immune-infiltrate, warning=F}
...
```{r boxplot-immune-infiltrate, fig.align="center", fig.cap="Heatmap and boxplot for immune infiltrate HSP x LSP comparsion", warning=F, fig.height=10.7,fig.width=8}
...
```{r heatmap-IM-expression, warning=F}
...
```{r boxplot-IM-characteristics, fig.align="center", fig.cap="Heatmap for Immune modulators gene expression and boxplot for Thorsson Immune characteristics", warning=F,  fig.height=10.7,fig.width=8}
...
```{r mutations-and-leukocyte-fraction, warning=F}
...
```{r statistical-correlations, warning=F}
...
```{r iAtlas-extracellular-network, message=F, fig.align="center", fig.cap="iAtlas Extracellular Communication Network", warning=F, results=F}
...
```{r heatmap-network, fig.align="center",  fig.cap="Heatmap for ACC nodes gene expression level on pan-cancer comparison", warning=F} 
# Heatmap construction with ComplexHeatmap
## Annotation columns
...
```{r scatterplot-checkpoint-blockade, fig.align="center", fig.cap="Scatter plot for CD8B with PDL1 and PDL2 gene expression", warning=F, message=F,  fig.width=5, fig.height=7}
...
```{r survival-analysis, fig.align="center",  fig.cap="Survival analysis", warning=F, fig.height=10.7,fig.width=8}
#### Survival analysis
...
```{r clinical-table, fig.cap="Clinical Table", fig.align="center", results=F, message=F, warning=F, fig.height=6}
# Clinical table
